...
public class AdocaoService {
    ...
    public void solicitar(Adocao adocao) {
        ...
        if (adocao.getPet().getAdotado() == true) {
            throw new ValidacaoException("Peti já foi adotadop!");
        } else {
    ...
    public void aprovar(Adocao adocao) {
        ...
        emailService.enviarEmail(
                ...
                "Parabéns " + adocao.getTutor().getNome() + "!\n\nSua adoção do pet "
                        + adocao.getPet().getNome() + ", solicitada em " + adocao.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"))
    ...
    public void reprovar(Adocao adocao) {
        ...
        emailService.enviarEmail(
                ...
                "Olá " + adocao.getTutor().getNome() + "!\n\nInfelizmente sua adoção do pet "
                        + adocao.getPet().getNome() + ", solicitada em " + adocao.getData().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")) + ", foi reprovada pelo abrigo "
