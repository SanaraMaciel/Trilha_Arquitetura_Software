...
public class AbrigoServiceTest {
    ...
    private ClientHttpConfiguration client = mock(ClientHttpConfiguration.class);//mock faz a simulacao daquele obj
    ...
    public void deveVerificarQuandoNaoHaAbrigo() throws IOException, InterruptedException {
        abrigo.setId(0L);
        String expected = "Nao existem abrigos cadastrados!";
